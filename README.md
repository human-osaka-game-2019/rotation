# このリポジトリについて
頂点や配列の回転についてのサンプルです。  
対象は『C言語に触れて2ヶ月足らずでC++を始めようとしている生徒達』ですので、new/delete・classの継承・constructor/destructor等のC++の機能は使わずに書いています。  
数学が苦手な人も、このREADMEの下の方にある『[基本の考え](#基本の考え)』は頑張ってマスターして下さいね💪📚📝📐
